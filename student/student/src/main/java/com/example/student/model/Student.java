...
public class Student {
	...
	@ManyToMany
	@JoinTable(name="course_student",joinColumns = {@JoinColumn(name="st_id")},inverseJoinColumns =  {@JoinColumn(name="course_id")})
	private List<Course> courses=new ArrayList<Course>();
	
	private Long semester;
	@ManyToMany
	@JoinTable(name="student_class",joinColumns = {@JoinColumn(name="st_id")},inverseJoinColumns =  {@JoinColumn(name="class_id")})
