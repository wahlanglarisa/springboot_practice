...
<body>
	<main id="main-content">
			<div class="modal fade" id="UpdateModal" data-bs-backdrop="static"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">Please Update User profile before proceeding to Home Page</div>

						<div class="modal-footer">
						

							<a id="updateUserLink" href="/studentMVC/updatestudent/${student.id}" class="btn btn-primary">
								Update Profile </a>
			...
			<button class="btn" data-bs-toggle="modal"
								data-bs-target="#UpdateModal"  hidden="true" id="updateUser">
								Delete</button>
